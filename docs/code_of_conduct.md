...
The NDK community is open to pretty much anyone. To ensure that project forums such as the Discord server and GitHub repository are open and friendly, we count on maintainers and project representatives to behave in a way that is not disruptive to NDK's culture or to any one participant's well-being.
...
Additionally, spam and other content which disrupts or prevents NDK contributors from working on NDK is not acceptable.

## The Code of Conduct Team

A small team of NDK contributors has volunteered to enforce the NDK Code of Conduct. If you feel like a community member has engaged in inappropriate behavior, please don't hesitate to contact one of the following NDK contributors via email or on Discord:
 * Matt Corallo - NDKcocpoc on mattcorallo.com
 ...
 * Did the event occur in a space within our Code of Conduct's scope?
   * If the incident occurred outside community forums and the individual is seen as a project representative or identifies as an NDK contributor, the incident may be in scope.
   * Additionally, an incident may be in scope if a community member's ability to contribute to NDK is impacted.
 ...
 * Does the incident impact the ability of individuals to freely contribute to NDK?
...
### Final warning:
If an incident or series of incidents creates sustained toxicity within the NDK Community, the Code of Conduct Team will sternly warn the reported party and raise the possibility of further disciplinary action. In addition, they may request that the reported party:
...
If the Code of Conduct Team’s warning goes unheeded, the individual(s) may be asked to avoid participating with the NDK Community on its preferred platforms for several months. After time has passed, the individual(s) will have the option of meeting with the team to discuss returning to the community.
